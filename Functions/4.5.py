...
def fastener_CG(h, t1, d2, mat, w, height, fnum): # h is the input of D4.2; t1 is the output of D4.3; d2 is the fastener diameter; mat should be either
    ...
    if symm:
        ...
        side_col1 = int(m.floor(col/2))+1
        side_col2 = int(m.floor(col/2))
...
fastener_CG(6, 2, 1, "metal", 45, 20, 8)
        #h, t1, d2, mat, w, height, fnum 