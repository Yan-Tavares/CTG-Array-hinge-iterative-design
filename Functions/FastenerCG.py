...
def fastener_CG(h, t1, d2, mat, w, fnum): # h is the input of D4.2; t1 is the output of D4.3; d2 is the fastener diameter; mat should be either
    ...
    return x_i, z_i, x_cg, z_cg, area
    
# Assign the return values to variables

# fastener_CG(6, 2, 1, "metal", 45, 8)
       # h, t1, d2, mat, w, fnum 